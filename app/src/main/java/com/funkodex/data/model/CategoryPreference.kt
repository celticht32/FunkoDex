...
object FunkoCategories {
    ...
    val ALL: List<CategoryDef> = listOf(
        ...
        // ── SPORTS ────────────────────────────────────────────────────────
        CategoryDef("pop_football",     "Pop! Football",        FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_basketball",   "Pop! Basketball",      FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_mlb",          "Pop! MLB",             FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_hockey",       "Pop! Hockey",          FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_nascar",       "Pop! NASCAR",          FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_wwe",          "Pop! WWE",             FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_golf",         "Pop! Golf",            FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_boxing",       "Pop! Boxing",          FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_cricket",      "Pop! Cricket",         FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_mls",          "Pop! MLS",             FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_nba_mascots",  "Pop! NBA Mascots",     FunkoGenre.SPORTS, defaultEnabled = false),
        CategoryDef("pop_college",      "Pop! College",         FunkoGenre.SPORTS, defaultEnabled = false),

        // ── ICONS & ADVERTISING ───────────────────────────────────────────
        CategoryDef("pop_ad_icons",     "Pop! Ad Icons",        FunkoGenre.ICONS, defaultEnabled = false),
        ...
        CategoryDef("pop_gpk",          "Pop! GPK",             FunkoGenre.ICONS, defaultEnabled = false),
        ...
        CategoryDef("pop_candy",        "Pop! Candy",           FunkoGenre.LIFESTYLE, defaultEnabled = false),
        CategoryDef("pop_aquasox",      "Pop! AquaSox",         FunkoGenre.LIFESTYLE, defaultEnabled = false),

        // ── MILITARY ──────────────────────────────────────────────────────
        CategoryDef("pop_air_force",    "Pop! Air Force",       FunkoGenre.MILITARY, defaultEnabled = false),
        CategoryDef("pop_army",         "Pop! Army",            FunkoGenre.MILITARY, defaultEnabled = false),
        CategoryDef("pop_marines",      "Pop! Marines",         FunkoGenre.MILITARY, defaultEnabled = false),
        CategoryDef("pop_navy",         "Pop! Navy",            FunkoGenre.MILITARY, defaultEnabled = false),
        ...
        CategoryDef("pop_pins",         "Pop! Pins",            FunkoGenre.OTHER, defaultEnabled = false),
        CategoryDef("pop_pez",          "Pop! Pez",             FunkoGenre.OTHER, defaultEnabled = false),
